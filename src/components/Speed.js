...
const magnitude = [
	0.036,3.6,1,1.09728,1.6092,1.85184,1225.08
];
export default function Speed() {
	const [light] = useContext(ThemeContext);
	const [first, setFirst] = useState("Kilometers per hour");
	const [a, setA] = useState("");
	const [second, setSecond] = useState("Kilometers per hour");
	...
	return (
		<StyledDiv light={light}>
			<h1><BsSpeedometer className='icon' /> The speed converter </h1>
			<div className='first'>
