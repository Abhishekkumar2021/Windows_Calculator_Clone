...
const magnitude = [
	0.2,0.001,0.01,0.1,1,10,100,1000,1000000,28.34952,453.5924,6350.293,907184.7,1016047
];

export default function Mass() {
	const [light] = useContext(ThemeContext);
	const [first, setFirst] = useState("Grams");
	const [a, setA] = useState("");
	const [second, setSecond] = useState("Grams");
	...
	return (
		<StyledDiv light={light}>
			<h1><FaBalanceScaleRight className='icon' /> The Mass converter </h1>
			<div className='first'>
