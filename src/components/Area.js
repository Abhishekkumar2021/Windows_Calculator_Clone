...
const magnitude = [
	0.000001,0.0001,1,10000,1000000,0.000645,0.92903,0.836127,4046.856,2589988,
];
export default function Area() {
	const [light] = useContext(ThemeContext);
	const [first, setFirst] = useState("Square meters");
	const [a, setA] = useState("");
	const [second, setSecond] = useState("Square meters");
	...
	return (
		<StyledDiv light={light}>
			<h1><AiOutlineAreaChart className='icon' /> The Area converter </h1>
			<div className='first'>
