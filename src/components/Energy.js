...
const list = [
    ...
    const magnitude = [
        1.6e-19,1,1000,4.184,4184,1.355818,1055.056
    ];

export default function Energy() {
	const [light] = useContext(ThemeContext);
	const [first, setFirst] = useState("Joules");
	const [a, setA] = useState("");
	const [second, setSecond] = useState("Joules");
	...
	return (
		<StyledDiv light={light}>
			<h1><GiRollingEnergy className='icon' /> The Energy converter </h1>
			<div className='first'>
