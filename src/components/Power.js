...
const magnitude = [
	1,1000,745.6999,0.022597,17.58427
];
export default function Power() {
	const [light] = useContext(ThemeContext);
	const [first, setFirst] = useState("Watts");
	const [a, setA] = useState("");
	const [second, setSecond] = useState("Watts");
	...
	return (
		<StyledDiv light={light}>
			<h1><BsPower className='icon' /> The power converter </h1>
			<div className='first'>
